    ...
    return(
        <div id="experience">
            ...
            <div id="exp1" className="expRight"
                    ...
                    {isShown7 && (      
                        <div id="info1" className="infoLeft">
                    ...
                    {isShown1 && (      
                        <div id="info2" className="infoRight">
                    ...
                    {isShown2 && (      
                        <div id="info3" className="infoLeft">
                    ...
                    {isShown3 && (      
                        <div id="info4" className="infoRight">
                    ...
                    {isShown4 && (
                        <div id="info5" className="infoLeft">
                    ...
                    {isShown5 && (
                        <div id="info6" className="infoRight">
                    ...
                    {isShown6 && (
                    <div id="info7" className="infoLeft">
